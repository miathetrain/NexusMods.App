...
{ fetchNuGet }: [
  ...
  (fetchNuGet { pname = "Avalonia.Headless"; version = "11.1.0-rc1"; hash = "sha256-FPwBj2Wypl4EQg6Xo3vsk1RZMnq36Kgj5Y55HkdUhik="; })
  ...
  (fetchNuGet { pname = "Microsoft.AspNetCore.WebUtilities"; version = "8.0.5"; hash = "sha256-jftUrR5JIodXUs7RR7lzCgzjgxu9D/QGsXfYjS6BbcE="; })
  ...
  (fetchNuGet { pname = "Microsoft.Net.Http.Headers"; version = "8.0.5"; hash = "sha256-+8nqfm0hq++VkN7EDNEyEpOHCfP9+KqPOkvtY4XPfpA="; })
  ...
  (fetchNuGet { pname = "NexusMods.Archives.Nx"; version = "0.4.0"; hash = "sha256-U0OXRaGXyBxKNXtntirsCEcGFR7l8LkOLMikHYKP2Wo="; })
  (fetchNuGet { pname = "NexusMods.Hashing.xxHash64"; version = "2.0.1"; hash = "sha256-LSSle8oclFougCUt3dS4syTa856WOWfSZmlBcl7QYhc="; })
  (fetchNuGet { pname = "NexusMods.MnemonicDB"; version = "0.9.60"; hash = "sha256-ZAYK9GDP5RbQopnMwkRE6sX9ULC+mpmAwr0hlonR2wY="; })
  (fetchNuGet { pname = "NexusMods.MnemonicDB.Abstractions"; version = "0.9.60"; hash = "sha256-KErnQeXtPO69zpW+w2MKbBE+r0FbK6+PwH2QXRA4oVA="; })
  (fetchNuGet { pname = "NexusMods.MnemonicDB.SourceGenerator"; version = "0.9.60"; hash = "sha256-KHjTz3q+6gzfBYkwDltcJpCmhAgerE4NcPgSI/Zjr/4="; })
  (fetchNuGet { pname = "NexusMods.MnemonicDB.Storage"; version = "0.9.60"; hash = "sha256-u5ikeysWNCeD1byQD7OzKDeYFaLGCwfj/Qwd18/B3JQ="; })
